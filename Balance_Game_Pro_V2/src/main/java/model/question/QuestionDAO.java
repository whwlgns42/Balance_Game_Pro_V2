...
public class QuestionDAO {
	...
	private static final String SELECTALL_ADMIN_TRUE = "SELECT Q.QID, Q.TITLE, Q.LOGIN_ID, Q.ANSWER_A, Q.ANSWER_B, EXPLANATION, REG_DATE FROM QUESTIONS Q WHERE Q_ACCESS = 'T' ORDER BY Q.QID ASC";

	private static final String SELECTALL_ADMIN_FALSE = "SELECT Q.QID, Q.TITLE, Q.LOGIN_ID, Q.ANSWER_A, Q.ANSWER_B, EXPLANATION, REG_DATE FROM QUESTIONS Q WHERE Q_ACCESS = 'F' ORDER BY Q.QID ASC";
