        ...
        <form action="adminTitleCreate.do" method="POST" id="insertForm">
         <div class="card-body">
          ...
          <div class="form-group">
           ...
           <textarea id="inputDescription" class="form-control" name="answer_A" rows="2"></textarea>
          </div>
          <div class="form-group">
           <label for="inputDescription">선택지B</label>
           <textarea id="inputDescription" class="form-control" name="answer_B" rows="2"></textarea>
          </div>
          <div class="form-group">
