					...
					<div class="split style1">
							...
							<div class="row gtr-uniform">
								...
								<div class="col-12-xsmall">
									<label for="loginId">아이디</label> <input type="text"
										class="loginId" name="loginId" id="loginIdCheck"
										placeholder="ID" />
									<div>
								...
								<div class="col-12">
									<label for="mPw">비밀번호</label> <input type="password" name="mPw"
										id="mPw" placeholder="password" />
								</div>

								<div class="col-12">
									<label for="mpwCh">비밀번호확인</label> <input type="password"
										name="mpwCh" id="mpwCh" placeholder="PasswordCk" />
									<!-- <div id="ok"></div> -->
								</div>

								<div class="col-12">
									<label for="age">나이</label> <input type="text" name="age"
										id="age" placeholder="나이를 입력하세요" oninput="validateAge(this)" />
									<!-- <div id="ok"></div> -->
								</div>
								...
								<div class="col-12">
									<label for="cellPhone">핸드폰번호</label> <input type="text"
										name="cellPhone" id="cellPhone" placeholder="Your PhoneNumber" />
									<button type="button" onclick="authCheck()">인증번호발송</button>
								</div>

								<div class="col-12">
									<label for="authCheck">인증번호</label> <input type="text"
										name="authNum" id="authNum" />
						...
						<section>
							...
							<ul class="alt">
								...
								<li><textarea name="" id="" style="resize: none;" readonly>여러분을 환영합니다.
              ...
              $.ajax({
                  ...
                  success: function(result) {
                      if (result == 1) {
                          ...
                          $("#id_feedback").css('font-size', '20px');
