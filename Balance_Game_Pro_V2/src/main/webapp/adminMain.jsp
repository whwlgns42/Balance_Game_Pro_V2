...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
							...
							<div class="media">
								...
								<div class="media-body">
									<h3 class="dropdown-item-title">
										유저1의ID <span class="float-right text-sm text-danger"><i class="fas fa-star"></i></span>
									</h3>
									<p class="text-sm">유저1</p>
									<p class="text-sm text-muted">
										<i class="far fa-clock mr-1"></i> 4 시간 전
									</p>
								</div>
							</div> <!-- Message End -->
						</a>
						...
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								...
								<div class="media-body">
									<h3 class="dropdown-item-title">
										유저2의ID <span class="float-right text-sm text-muted"><i class="fas fa-star"></i></span>
									</h3>
									<p class="text-sm">유저2</p>
									<p class="text-sm text-muted">
										<i class="far fa-clock mr-1"></i> 3 시간 전
									</p>
								</div>
							</div> <!-- Message End -->
						</a>
						...
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								...
								<div class="media-body">
									<h3 class="dropdown-item-title">
										유저3의ID <span class="float-right text-sm text-warning"><i class="fas fa-star"></i></span>
									</h3>
									<p class="text-sm">유저3의ID</p>
									<p class="text-sm text-muted">
										<i class="far fa-clock mr-1"></i> 1 시간 전
									</p>
								</div>
							</div> <!-- Message End -->
						</a>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="index3.html" class="brand-link"> <img src="image/자비스.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> <span class="brand-text font-weight-light">관리자</span>
			</a>
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item menu-open"><a href="#" class="nav-link active"> <i class="nav-icon fas fa-tachometer-alt"></i>
								<p>
									더보기 <i class="right fas fa-angle-left"></i>
								</p>
						</a>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">BalanceGame 관리자 페이지</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
