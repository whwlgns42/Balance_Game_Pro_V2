        ...
        <c:when test="${not empty member}">
         ...
         <div class="card-body">
          <div class="form-group">
           <label for="name">이름:</label> <input class="form-control" type="text" name="name" value="${member.name}">
          </div>
          <div class="form-group">
           <label for="email">이메일:</label> <input class="form-control" type="text" name="email" value="${member.email}">
          </div>
          <div class="form-group">
           <label for="address">주소:</label> <input class="form-control" type="text" name="address" value="${member.address}">
          </div>
          <div class="form-group">
           <label for="age">나이:</label> <input class="form-control" type="text" name="age" value="${member.age}">
          </div>
         </div>
        </c:when>
        <c:otherwise>
        ...
        <tbody>
         ...
         <c:forEach var="data" items="${cdatas}" varStatus="loop">
          <tr>
           ...
           <td><input id="cId" type="hidden" value="${data.cId}" /> console.log("${data.cId}")
